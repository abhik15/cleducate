...
<%-- 
  ...
  -- 4. Mumbai
  -- 5. Noida
  -- 6. Faridabad ######ADDED ON MAY 3, 2003 BY SHILPA (GREAT SYSTEM DESIGN, ADDING A KEYWORD IS SO EASY)
  -- 7. Thane
  -- 8.	Chandigarh
  -- 9.	Pune
  -- 10.Network
...
<!--
  ...
  -->
<form method="post" action="/msg/list/MSGLocationTree.jsp" name="treeForm">
