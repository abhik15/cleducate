...
<%@ page import="java.sql.*,oracle.jdbc.driver.*,com.cl.sql.SISPoolManager2" %> 
...
<jsp:useBean id="MockTests" scope="session" class="com.cl.testseries.TSStudentTests"/>
<jsp:useBean id="FLTTests" scope="session" class="com.cl.testseries.TSStudentTests"/>
<%
	...
	String source="/index.html";//request.getParameter("source");
	String target="/sis/analysis/ANLReportCardCaching.jsp?&testID=1";


	String productID="|0|";
	String productCategory ="|";
	String enrollStatus="na";
	String sourceProductID="|"+prodId+"|";//request.getParameter("sourceProductID");
	Statement stmt=null;
	try
	{
...
<%
			...
			MockTests.setEnrollID(StudentLogin.getEnrollID());
			MockTests.setCustomerID(StudentLogin.getCustomerID());
			MockTests.setTestID(1);
			MockTests.setUserID(connection, StudentLogin.getUserID());
	}
		...
		else 
		{
			...
			if(sourceProductID.indexOf(productID)>-1 || sourceProductID.indexOf("|0|")>-1)
			{
					...
					rd = application.getRequestDispatcher(target);
